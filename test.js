...
describe('scaler', function() {
    describe('discrete', function() {
        ...
        it('should scale down a list with negatives 2', function() {
            expect(scaler.scale([-10, 5, -1], {
                min: -5,
                max: -3
            })).to.eql([-5, -3, -4]);
        });
        ...
        it('should throw an error when more uniques than spread', function() {
            expect(scaler.scale).withArgs([1, 2, 3], {
                ...
                expect(e.message).to.eql('Count of unique items (3) is more than spread (2) / step (1)');
            });
        });
